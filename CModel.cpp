...
void CModel::MoveModelTo(double x_Coordinate, double y_Coordinate, double z_Coordinate)
{
	for (int i = 0; i < _num_of_polygons; i++)
	{
		_polygons_array[i].MovePolygonTo(x_Coordinate,y_Coordinate,z_Coordinate);
	}
}
...
CPoint CModel::GetModelCenter()
{
	...
	for (int i = 0; i < _num_of_polygons; i++)
	{
		sum1.MovePoint(_polygons_array[i].GetPolygonCenter());
	}
	double scaleRatio = 1.0 / _num_of_polygons;
