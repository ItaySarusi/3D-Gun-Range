...
void CPolygon::MovePolygonTo(double x_Coordinate, double y_Coordinate, double z_Coordinate)
{
	for (int i = 0; i < _num_of_points; i++)
		_points_array[i].MovePointTo(x_Coordinate,y_Coordinate,z_Coordinate);
}
...
void CPolygon::MovePolygonCenter(double x_coordinate, double y_coordinate, double z_coordinate)
{
	...
	MovePolygon(x_coordinate - p1.GetCoordinate(X_AXIS), y_coordinate - p1.GetCoordinate(Y_AXIS), z_coordinate - p1.GetCoordinate(Z_AXIS));
}
